...
public class PopUpDeleteCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_up_delete_category);
    ...
    private void setupViewsData(){
        TextView questionView = findViewById(R.id.categoryDeleteQuestionTextView);
        yes = findViewById(R.id.buttonCategoryYes);
        no = findViewById(R.id.buttonCategoryNo);
