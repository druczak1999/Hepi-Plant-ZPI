...
public class CategoryEditActivity extends AppCompatActivity {
    ...
    private void setupToolbar() {
        ...
        toolbar.setTitle("Edytuj kategorię");
        setSupportActionBar(toolbar);
    }

    private void setupViewsData() {
        TextView idTextView = findViewById(R.id.categoryEditIdTextView);
        idTextView.setText(String.format(Locale.GERMANY,"%d", category.getId()));
