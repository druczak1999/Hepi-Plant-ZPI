...
public class PopUpDeleteEvent extends AppCompatActivity {
    ...
    private void deleteEvent(){
        ...
        requestProcessor.makeRequest(Request.Method.DELETE, url, null, RequestType.STRING,
            (Response.Listener<String>) response -> {
                ...
                Toast.makeText(getApplicationContext(),getText(R.string.delete_event),Toast.LENGTH_LONG).show();
    ...
    private void onErrorResponseReceived(VolleyError error){
        ...
        Toast.makeText(getApplicationContext(),getText(R.string.delete_event_failed),Toast.LENGTH_LONG).show();
